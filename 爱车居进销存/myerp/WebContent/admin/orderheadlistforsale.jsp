...
<body>
<p class="path">爱车居后台系统/销售管理/销售订单</p>
...
<table border="0" cellspacing="0" cellpadding="0" class="tb tblist">
       ...
       <%for (Map<String, Object> m : list) { %>
        <tr>
       		...
       		<td><%=m.get("sumprice")%>万</td>
       		<td><%=m.get("ctime")%></td>
       		<td><a href="orderviewforsale?orderid=<%=m.get("orderid")%>">查看详细</a><a href="orderdeleteforsale?orderid=<%=m.get("orderid")%>">删除</a>  </td>
       </tr>
    	<% } %>
    </table>
