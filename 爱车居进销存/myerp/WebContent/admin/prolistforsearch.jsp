...
%>
<div class="path">当前位置:/爱车居进销存系统/库存管理/库存查询             <span class="rightbox"><input type="text" id="tbkey"/><input type="button" id="btnsearch" value="查询"/></span></div>
...
<table border="0" cellspacing="0" cellpadding="0" class="tb tblist">
       ...
       <%for (Map<String, Object> m : list) { %>
        <tr>
       		<td><%=m.get("id")%></td>
       		<td><img src="./upload/<%=m.get("imgurl")%>" style="width:120px;height60px;padding:5px 0px;"></td>
