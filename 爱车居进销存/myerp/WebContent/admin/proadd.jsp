...
<html>
	...
	<body>
		<form action="../proadd" method="post" enctype="multipart/form-data">
			<p class="path">当前位置：爱车居进销存系统/产品中心/新增商品</p>
			<table border="0" cellspacing="0" cellpadding="0" class="tb">
				...
				<tr><td class="lable">车身结构</td><td><input type="text" name="brief"/></td></tr>
				<tr><td class="lable">发动机</td><td><input type="text" name="address"/></td></tr>
